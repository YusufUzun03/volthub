...
-- ═══════════════════════════════════════════════════════════
--  VOLTHUB · PDF İÇİ ARAMA + YENİ ÖZELLİKLER
--  SQL Editor → New query → yapıştır → Run.
-- ═══════════════════════════════════════════════════════════

-- PDF'ten çıkarılan metin (yükleme anında client-side PDF.js ile doldurulur)
alter table public.files add column if not exists content_text text default '';
